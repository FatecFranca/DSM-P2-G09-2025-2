...
3- criar um banco de dados com o Script
4- criar a conexao do seu banco local com o backend (conexao.js)
5- abrir o prompt de comando na pasta do repositorio 
6- instalar dependencias do node(npm install)
7- usar o comando "node server.js" 
8- entrar no link: "localhost:3000" 
```
