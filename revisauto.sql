...
CREATE TABLE checklist (
    ...
    fotos TEXT,
    criado_em DATETIME,
    FOREIGN KEY (fk_id_veiculo) REFERENCES cad_veiculo(id_veiculo)
);
...
CREATE INDEX idx_cad_cliente_nome ON cad_cliente(nome);
CREATE INDEX idx_cad_cliente_cpf ON cad_cliente(cpf);
CREATE INDEX idx_cad_cliente_tipo ON cad_cliente(tipo_pessoa);
CREATE INDEX idx_cad_cliente_cnpj ON cad_cliente(cnpj);

CREATE INDEX idx_cad_veiculo_placa on cad_veiculo(placa);
CREATE INDEX idx_cad_veiculo_id_cliente on cad_veiculo(fk_id_cliente);
CREATE INDEX idx_cad_veiculo_modelo on cad_veiculo(modelo);